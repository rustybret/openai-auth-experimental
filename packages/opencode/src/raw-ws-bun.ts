      ...
      this.socket = (await connectFn({
        ...
        socket: {
          ...
          close: () => {
            ...
            // 1006 means "closed with no code" and is a last resort. The peer's
            // own code says why it hung up, and callers act on it, so a parsed
            // close frame wins even though the TCP close lands first.
            this.emitClose(
